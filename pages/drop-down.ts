...
export class DropDown extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.dropdownItem1 = page.locator('#multi-level-menu-ul > li.dropdown-item > a')
        this.dropdownItem2 = page.locator('#multi-level-menu-ul > li.dropdown-submenu > a.dropdown-item')
